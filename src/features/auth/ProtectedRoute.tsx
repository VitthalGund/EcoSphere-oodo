    ...
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-surface">
        <div className="text-center">
          ...
          <p className="mt-4 text-text-secondary text-sm font-medium">Verifying authorization...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-surface p-6">
        <div className="w-full max-w-md text-center bg-base p-8 rounded-xl border border-border shadow-md">
          ...
          <h2 className="text-xl font-bold text-text-primary">Unauthorized Access</h2>
          <p className="mt-2 text-sm text-text-secondary">
            Your account role <strong>({profile.role})</strong> does not have permission to view this page.
          </p>
          <div className="mt-6">
            <Navigate to="/" replace />
            <button

...
-- =========================================================================
-- 3. OTHER DEPENDENCIES (Categories, Factors, Badges, Rewards)
-- =========================================================================
...
-- =========================================================================
-- 3. DEMO DATA SEEDING (Emissions, Challenges, CSR, Policies, Logs)
-- =========================================================================
...
('b0000000-1111-1111-1111-111111111111', 'Zero Waste Week', 'c3333333-3333-3333-3333-333333333333', 'Avoid all single-use plastics, compost lunch leftovers, and log zero landfill trash for 5 consecutive workdays.', 150, 'Easy', true, '2026-08-01', 'active', '11111111-1111-1111-1111-111111111111'),
('b0000000-2222-2222-2222-222222222222', 'Active Commuter Challenge', 'c2222222-2222-2222-2222-222222222222', 'Commute to the office using cycling, running, or walking for at least 15 kilometers in a single calendar week.', 300, 'Medium', true, '2026-08-15', 'active', '11111111-1111-1111-1111-111111111111'),
('b0000000-3333-3333-3333-333333333333', 'Vampire Power Shutdown', 'c1111111-1111-1111-1111-111111111111', 'Unplug all electrical screens, laptop docks, and chargers before leaving the office to prevent passive grid usage.', 100, 'Easy', false, '2026-08-30', 'active', '22222222-2222-2222-2222-222222222222'),
('b0000000-4444-4444-4444-444444444444', 'Green IT Hardware Audit', 'c1111111-1111-1111-1111-111111111111', 'Run energy efficiency configuration audits on all local department servers and virtual machine containers.', 500, 'Hard', true, '2026-09-01', 'active', '11111111-1111-1111-1111-111111111111')
ON CONFLICT (id) DO NOTHING;
...
-- Engineering HQ Utilities (Priya & others)
('e0000000-1111-1111-1111-111111111111', 'd1111111-1111-1111-1111-111111111111', 'e1111111-1111-1111-1111-111111111111', 'electricity', 'HQ Main Server Rack Electricity Usage - June 2026', 12500, 5625.00, '2026-06-30', 'manual', '11111111-1111-1111-1111-111111111111'),
('e0000000-2222-2222-2222-222222222222', 'd1111111-1111-1111-1111-111111111111', 'e2222222-2222-2222-2222-222222222222', 'natural_gas', 'HQ Heating Natural Gas Utilities - June 2026', 1500, 2820.00, '2026-06-30', 'manual', '11111111-1111-1111-1111-111111111111'),

-- Sales Travel and Office operations (Meera & others)
('e0000000-3333-3333-3333-333333333333', 'd2222222-2222-2222-2222-222222222222', 'e5555555-5555-5555-5555-555555555555', 'flight', 'Business flight from New York to London (Sales Pitch)', 5500, 1045.00, '2026-07-02', 'manual', '22222222-2222-2222-2222-222222222222'),
('e0000000-4444-4444-4444-444444444444', 'd2222222-2222-2222-2222-222222222222', 'e6666666-6666-6666-6666-666666666666', 'office_supplies', 'Bulk recycled paper purchase for sales proposals', 200, 184.00, '2026-07-06', 'ai_classifier', '22222222-2222-2222-2222-222222222222'),

-- Operations Logistics (Raj & others)
('e0000000-5555-5555-5555-555555555555', 'd4444444-4444-4444-4444-444444444444', 'e3333333-3333-3333-3333-333333333333', 'fleet', 'Logistics Fleet Delivery Vans Diesel Refill', 3400, 9112.00, '2026-07-08', 'manual', '33333333-3333-3333-3333-333333333333'),
('e0000000-6666-6666-6666-666666666666', 'd4444444-4444-4444-4444-444444444444', 'e8888888-8888-8888-8888-888888888888', 'waste', 'Operations Warehouse municipal waste disposal', 1.8, 840.60, '2026-07-10', 'ai_classifier', '33333333-3333-3333-3333-333333333333')
ON CONFLICT (id) DO NOTHING;
...
-- Admin Priya signed ethics and compliance policies
('f0000000-1111-1111-1111-111111111111', 'a0000000-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', now() - interval '25 days'),
('f0000000-2222-2222-2222-222222222222', 'a0000000-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', now() - interval '8 days'),

-- Dept Head Meera signed whistleblower and supplier policies
('f0000000-3333-3333-3333-333333333333', 'a0000000-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', now() - interval '18 days'),
('f0000000-4444-4444-4444-444444444444', 'a0000000-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', now() - interval '3 days'),

-- Employee Raj signed ethics and whistleblower codes
('f0000000-5555-5555-5555-555555555555', 'a0000000-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', now() - interval '15 days'),
('f0000000-6666-6666-6666-666666666666', 'a0000000-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', now() - interval '12 days')
ON CONFLICT (id) DO NOTHING;

-- Insert Challenge Participations (Gamification Action Stream)
...
-- Meera completed Vampire Power challenge
('f000aaaa-1111-1111-1111-111111111111', 'b0000000-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 100, 'Proof of shut down uploaded', 'approved', 100, '11111111-1111-1111-1111-111111111111', now() - interval '6 days'),

-- Raj completed Zero Waste challenge (approved by Meera)
('f000aaaa-2222-2222-2222-222222222222', 'b0000000-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 100, 'Shared a picture of reusable lunch containers used throughout the week.', 'approved', 150, '22222222-2222-2222-2222-222222222222', now() - interval '4 days'),

-- Raj has a pending active commuter challenge (being reviewed)
('f000aaaa-3333-3333-3333-333333333333', 'b0000000-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', 75, 'Biked 12km to the office. 3km remaining.', 'pending', 0, NULL, now() - interval '1 day')
ON CONFLICT (id) DO NOTHING;

-- Insert Employee Volunteering Hours (Social CSR Activity Participations)
...
-- Raj volunteered in Urban Reforestation (approved by Meera, earned 100 points)
('f000bbbb-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'c0000000-aaaa-bbbb-cccc-dddddddddd01', 'Volunteered 4 hours. Seeded 5 oak saplings.', 'approved', 100, now() - interval '7 days', '22222222-2222-2222-2222-222222222222', now() - interval '7 days'),

-- Meera participated in Youth Workshop
('f000bbbb-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'c0000000-aaaa-bbbb-cccc-dddddddddd02', 'Taught local school kids about natural greenhouse gases.', 'approved', 120, now() - interval '1 day', '11111111-1111-1111-1111-111111111111', now() - interval '1 day')
ON CONFLICT (id) DO NOTHING;

-- =========================================================================
-- 4. PROFILE & STATS RECALCULATION
-- =========================================================================

-- Sync User profiles balances to reflect earned values from above activities
UPDATE public.users SET xp = 250, level = 1, points_balance = 100 WHERE id = '33333333-3333-3333-3333-333333333333';
UPDATE public.users SET xp = 220, level = 1, points_balance = 120 WHERE id = '22222222-2222-2222-2222-222222222222';

-- Recalculate scoring caches (triggers the score recalculation routines)
-- SELECT public.calculate_all_department_scores();
